# En este proyecto se realiza la consulta de la temperatura del clima satisfactoriamente pero no se logra traer la consulta de los 6 días ya que que toca pagar para realizar ese proceso en la API.
